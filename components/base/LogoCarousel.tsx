...
import VercelIcon from "@/public/icons/apps/VercelIcon"
import PostgresqlIcon from "@/public/icons/apps/PostgresqlIcon"
import MysqlIcon from "@/public/icons/apps/MysqlIcon"
import TailwindCSSIcon from "@/public/icons/apps/TailwindCSSIcon"
import TypeScriptIcon from "@/public/icons/apps/TypeScriptIcon"
import NextjsIcon from "@/public/icons/apps/NextjsIcon"
import NodejsIcon from "@/public/icons/apps/NodejsIcon"
import SupabaseIcon from "@/public/icons/apps/SupabaseIcon"
import OpenAIIconBlack from "@/public/icons/apps/OpenAIIcon"
import DockerIcon from "@/public/icons/apps/DockerIcon"
import JavascriptIcon from "@/public/icons/apps/JavascriptIcon"
import ReactjsIcon from "@/public/icons/apps/ReactjsIcon"
import FlaskIcon from "@/public/icons/apps/FlaskIcon"
...
function LogoCarousel({ columnCount = 2 }: { columnCount?: number }) {
  ...
  const allLogos: Logo[] = useMemo(
    () => [
      { name: "Postgresql", id: 1, img: PostgresqlIcon },
      { name: "CEO Supabase", id: 2, img: SupabaseIcon },
      { name: "Mysql", id: 3, img: MysqlIcon },
      { name: "Typescript", id: 4, img: TypeScriptIcon },
      { name: "Nextjs", id: 5, img: NextjsIcon },
      { name: "Tailwind", id: 6, img: TailwindCSSIcon },
      { name: "Javascript", id: 7, img:JavascriptIcon },
      { name: "Reactjs", id: 8, img: ReactjsIcon},
      { name: "Nodejs", id: 9, img: NodejsIcon },
      { name: "Vercel", id: 10, img: VercelIcon },
      { name: "OpenAI", id: 11, img: OpenAIIconBlack },
      { name: "Docker", id: 12 , img: DockerIcon },
      { name: "Flask", id: 13, img:FlaskIcon}
    ],
    []
  )
