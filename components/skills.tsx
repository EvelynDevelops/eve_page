...
export default function TechStackCard() {
  return (
    <div className="border border-gray-700 rounded-sm p-4 w-72 max-w-3xl mx-auto bg-transparent">

      <div className="grid grid-cols-6 gap-y-2 gap-x-2 justify-items-center">
